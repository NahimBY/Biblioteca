$(document).ready(function () {
  ...
  $(document).on('click', '.btnCompleted', function() {
    ...
    $(document).off('click', '.completar').on('click', '.completar', function(){
      $.ajax({
          url: 'https://biblioteca-x1al.onrender.com/api/completarPrestamo', // URL del servidor para ejecutar el proceso
          type: 'POST',
          ...
          success: function(response) {
              ...
              $.ajax({
                url: 'https://biblioteca-x1al.onrender.com/api/mostrarPrestamosAdmin',
                method: 'GET',
  ...
  function obtenerDatosLibro(idLibro) {
    $.ajax({
      url: 'https://biblioteca-x1al.onrender.com/api/edit-book',
      method: 'GET',
      data: { id: idLibro },
      success: function (data) {
  ...
  function actualizarLibro(idLibro) {
    $(document).off('click', '.actualizar').on('click', '.actualizar', function () {
      ...
      if (isValid) {
        ...
        $.ajax({
          url: 'https://biblioteca-x1al.onrender.com/api/actualizarLibro',
          method: 'POST',
          contentType: 'application/json',
          ...
          success: function (response) {
            ...
            $.ajax({
              url: 'https://biblioteca-x1al.onrender.com/api/mostrarTodosLosLibros',
              method: 'GET',
              success: function (data) {
                allRecords = data;
                paginateRecords();
  ...
  $(document).on('click', '.addBtn', function(){
    ...
    $(document).off('click', '.add').on('click', '.add', function(){
      ...
      if (isValid) {
        ...
        $.ajax({
          url: 'https://biblioteca-x1al.onrender.com/api/agregarLibro',
          method: 'POST',
          contentType: 'application/json',
 ...
 /////////////////////////////////////////////////////////////////////////////
  ...
  $(document).on('click', '.incidentBtn', function(){
    ...
    $(document).off('click', '.incident').on('click', '.incident', function(){
      ...
      if (isValid) {
        ...
        $.ajax({
          url: 'https://biblioteca-x1al.onrender.com/api/agregarIncidente',
          method: 'POST',
          contentType: 'application/json',
          ...
          success: function (response) {
            ...
            $.ajax({
              url: 'https://biblioteca-x1al.onrender.com/api/mostrarIncidentes',
              method: 'GET',
              success: function (data) {
  ...
  function obtenerDatosIncidente(id) {
    $.ajax({
      url: 'https://biblioteca-x1al.onrender.com/api/edit-incident',
      method: 'GET',
      data: { id: id },
      success: function (data) {
        // console.log(data);
  ...
  function actualizarIncident(id) {
    $(document).off('click', '.edit-incident').on('click', '.edit-incident', function () {
      ...
      if (isValid) {
        ...
        $.ajax({
          url: 'https://biblioteca-x1al.onrender.com/api/actualizarIncidente',
          method: 'POST',
          contentType: 'application/json',
          data: JSON.stringify(datosActualizados),
          success: function (response) {
  ...
  $('#incident-matricula').on('input', function() {
    ...
    if (term.length >= 2) {
      $.get('https://biblioteca-x1al.onrender.com/api/buscarMatricula', { term: term }, function(data) {
  ...
  $('#incident-titulo').on('input', function() {
    ...
    if (term.length >= 2) {
      $.get('https://biblioteca-x1al.onrender.com/api/buscarLibro', { term: term }, function(data) {
  ...
  $('#incident-titulo').on('change', function() {
    ...
    if (titulo.length > 0) {
      $.get('https://biblioteca-x1al.onrender.com/api/obtenerIdLibro', { titulo: titulo }, function(data) {
        if (data.length > 0) {
